...
from src.scenarios.buzz_wire.util.observation_translator import ObsConcatTranslatorBuzzWire
import numpy as np
import torch

class ModelRewardBuzzWireScenario(BuzzWireScenario):
    """
    class ModelRewardBuzzWireScenario wraps the VMAS Scenario
    ...
    def reward(self, agent: Agent) -> AGENT_REWARD_TYPE:
        ...
        if is_first:
            ...
            translated_obs = [ObsConcatTranslatorBuzzWire.to_(raw_obs=np.array(o)).tolist() for o in obs]
