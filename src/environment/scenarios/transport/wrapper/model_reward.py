...
from src.scenarios.transport.util.observation_translator import ObsConcatTranslatorTransport
import numpy as np
import torch

class ModelRewardTransportScenario(TransportScenario):
    """
    class ModelRewardTransportScenario wraps the VMAS Scenario
    ...
    def reward(self, agent: Agent) -> AGENT_REWARD_TYPE:
        ...
        if is_first:
            ...
            translated_obs = [ObsConcatTranslatorTransport.to_(raw_obs=np.array(o)).tolist() for o in obs]
