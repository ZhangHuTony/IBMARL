...
from src.scenarios.navigation.util.observation_translator import ObsConcatTranslatorNavigation
import numpy as np
import torch

class ModelRewardNavigationScenario(NavigationScenario):
    """
    class ModelRewardNavigationScenario wraps the VMAS Scenario
    ...
    def reward(self, agent: Agent) -> AGENT_REWARD_TYPE:
        ...
        if is_first:
            ...
            translated_obs = [ObsConcatTranslatorNavigation.to_(raw_obs=np.array(o)).tolist() for o in obs]
